module.exports = function (client) {
  ...
  return {
    create: function (req, res, next) {
      ...
      client.sadd([ 'redsee-blacklist:ascii' ].concat(req.body.msg), function (error, amountAdded) {
  ...
  , delete: function (req, res, next) {
      ...
      client.srem([ 'redsee-blacklist:ascii' ].concat(req.body.msg), function (error, amountDeleted) {
        if (error) return next(error)
