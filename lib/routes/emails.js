...
module.exports = function (client) {
  ...
  return {
    create: function (req, res, next) {
      ...
      client.sadd([ client.prefix + 'redsee-whitelist:emails' ].concat(results), function (error, amountAdded) {
  ...
  , delete: function (req, res, next) {
      ...
      client.srem([ client.prefix + 'redsee-whitelist:emails' ].concat(results), function (error, amountDeleted) {
        if (error) return next(error)
